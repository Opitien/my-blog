    ...
    <aside className="space-y-12 w-full lg:max-w-[320px]">
      ...
      <div>
        ...
        <ul className="space-y-4">
          {[
            { title: "3 Dreaming Tips Will Change Your Lives for the Better if enoy and jealousy are impacting your friendships", date: "June 21, 2022", img: "/images/small-article1.jpg", dark: true },
            { title: "3 Dreaming Tips Will Change Your Lives for the Better if enoy and jealousy are impacting your friendships", date: "June 20, 2022", img: "/images/small-article2.jpg", dark: false },
            { title: "3 Dreaming Tips Will Change Your Lives for the Better if enoy and jealousy are impacting your friendships", date: "June 19, 2022", img: "/images/small-article3.jpg", dark: false },
            { title: "3 Dreaming Tips Will Change Your Lives for the Better if enoy and jealousy are impacting your friendships", date: "June 18, 2022", img: "/images/small-article4.jpg", dark: false },
          ].map((item, i) => (
            <li key={i} className={`flex gap-4 group cursor-pointer p-3 rounded-md transition ${item.dark ? 'bg-black text-white' : 'hover:bg-gray-50'}`}>
              ...
              <div className="flex flex-col justify-center">
                <h5 className={`text-[11px] font-bold leading-snug line-clamp-2 ${item.dark ? 'text-white' : 'text-gray-900'}`}>
                  {item.title}
                </h5>
